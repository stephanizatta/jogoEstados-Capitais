      ...
      *>-----Declaração dos recursos externos
       ...
       file-control.
           ...
           select estadosCapitais assign to "estadosCapitais.txt"
           organization is line sequential
           access mode is sequential
           lock mode is automatic
           file status is ws-fs-estadosCapitais.
      ...
      *>----Variaveis de trabalho
       ...
       77  ws-fs-estadosCapitais                   pic  9(02).
      ...
      *>------------------------------------------------------------------------
       inicializa section.
           ...
           open input estadosCapitais
           if ws-fs-estadosCapitais <> 0 then
               move 1                                     to ws-msn-erro-ofsset
               move ws-fs-estadosCapitais                 to ws-msn-erro-cod
               move "Erro ao abrir arq. estacosCapitais " to ws-msn-text
               perform finaliza-anormal
           end-if

           perform varying ws-ind-est from 1 by 1 until ws-fs-estadosCapitais = 10
                                                     or ws-ind-est > 27

               read estadosCapitais into ws-estados(ws-ind-est)
               if ws-fs-estadosCapitais <> 0
               and ws-fs-estadosCapitais <> 10 then
